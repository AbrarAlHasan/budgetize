...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  {
    ...
    description:
      "Track expenses, manage multiple accounts, and achieve your financial goals effortlessly",
    icon: "wallet",
    color: "#3B82F6",
  ...
  },
  {
    ...
    title: "Smart Money\nManagement",
    description:
      "Organize your finances with powerful features designed for simplicity",
    icon: "analytics",
    color: "#10B981",
  ...
  },
  {
    ...
    title: "Start Your\nFinancial Journey",
    description:
      "Join thousands who've taken control of their money. Your data stays private and secure.",
    icon: "rocket",
    color: "#8B5CF6",
