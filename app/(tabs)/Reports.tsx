...
import { useReportSummary, useCategoryReport, useAccountReport } from '@/hooks/queries/use-reports';
                    ...
                    <View>
                      ...
                      <Text className={`
                        ...
                        ${summary.netAmount >= 0 
                          ...
                          : 'text-red-600'}
                      `}>
                        ${summary.netAmount.toLocaleString(undefined, {
                          minimumFractionDigits: 2,
                          maximumFractionDigits: 2,
                        })}
                      </Text>
                        ...
                        <View className="items-end">
                          <Text className={`
                            ...
                            ${account.netAmount >= 0 
                              ...
                              : 'text-red-600'}
                          `}>
                            ${account.netAmount.toLocaleString(undefined, {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </Text>
                      ...
                      <View className="flex-row gap-4 mt-3">
                        <View className="flex-1">
                          ...
                          <Text className="text-sm font-semibold text-red-500">
                            ${account.expenses.toLocaleString(undefined, {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </Text>
                        ...
                        <View className="flex-1">
                          ...
                          <Text className="text-sm font-semibold text-green-500">
                            ${account.income.toLocaleString(undefined, {
                              minimumFractionDigits: 2,
                              maximumFractionDigits: 2,
                            })}
                          </Text>
